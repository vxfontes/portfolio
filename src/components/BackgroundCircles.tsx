...
const BackgroundCircles = () => {
    return (
        <motion.div
            ...
            {/* <div className="absolute border border-[#b8b8b8] rounded-full h-[200px] w-[200px] mt-52 animate-ping" /> */}
            {/* <div className="absolute border border-[#ec5aff] rounded-full opacity-20 h-[650px] w-[650px] mt-52 animate-pulse" /> */}
